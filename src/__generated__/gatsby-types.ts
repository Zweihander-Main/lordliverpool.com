...
type BookCoverQueryVariables = Exact<{ [key: string]: never; }>;


type BookCoverQuery = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> };
